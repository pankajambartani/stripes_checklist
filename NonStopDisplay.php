...
<body>
	<div id="topbar"><h2>Non Stops Products</h2><a id="back" href="index.php">Home</a></div>
	<div id="w">
		<div id="content">
			...
			$sql_bugs= "SELECT bug_id, short_desc, assigned_to, Remark FROM nonstopanswer where bug_id=".$bugId;
			...
			$sql = substr($sql ,0,-1);
			$sql_answer .= $sql ." FROM nonstopanswer WHERE bug_id=".$bugId;

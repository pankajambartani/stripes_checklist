	...
	<div id="w">
		<div id="content">
			...
			if ($_POST['SubmitBtn'] == "Save As Draft") {
				$sql1= "";
				$sql2= "";
				$sql = "INSERT INTO  checklist.storagetemp(`bug_id`,`assigned_to`,`short_desc`,`product_name`,`Remark`,";
			...
			elseif ($_POST['SubmitBtn'] == "Submit") {
				$sql1= "";
				$sql2= "";
				$sql = "INSERT INTO  checklist.storageanswer(`bug_id`,`assigned_to`,`short_desc`,`product_name`,`Remark`,";
					foreach ($_POST['questions'] as $id) {
						$sql2 .= "`$id`,";
					}
					$sql2 = substr($sql2 ,0,-1);

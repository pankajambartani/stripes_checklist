	...
	<div id="w">
		<div id="content">
			...
			if ($_POST['SubmitBtn'] == "Update") {
				...
				$sql="";
				$sql1="";
				$sql = "UPDATE checklist.hpuxtemp SET bug_id ='$bug_id',assigned_to ='$assigned_to', short_desc='$short_desc',product_name='$product_name', Remark = '$Remark',";
				for ($i=0; $i < $max ; $i++) { 
			...
			elseif ($_POST['SubmitBtn'] == "Submit") {
				...
				$sql1= "";
				$sql2= "";
				$sql = "INSERT INTO  checklist.hpuxanswer(`bug_id`,`assigned_to`,`short_desc`,`product_name`,`Remark`,";
				...
				$sql_delete = "DELETE FROM checklist.hpuxtemp WHERE bug_id=".$bug_id;
				...
				echo "<div style= 'line-height: 300%; font-weight:bold;'><center><a href = 'http://gen88.in.rdlabs.hpecorp.net/stripes_checklist/HPUXDisplay.php?bugId=".urlencode($bug_id)."&product_name=".urlencode($product_name)."' target='_blank'>http://gen88.in.rdlabs.hpecorp.net/stripes_checklist/HPUXDisplay.php?bugId=".$bug_id."&product_name=".$product_name."</a></center></div>";
